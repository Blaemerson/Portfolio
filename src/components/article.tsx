...
export const ArticlePreview = (props: ArticleWithUser) => {
  ...
  return (
    <Link href={`/blog/${article.id}`}>
      <div
        key={article.id}
        className="text-md items-between my-4 flex bg-gray-50 text-slate-700 transition duration-200 ease-in-out hover:bg-white hover:shadow-xl sm:text-xl"
      >
        <img
        ...
        <span className="m-2 flex items-end gap-x-2 font-bold hover:text-blue-400">
          {commentCount}
          <svg
