      ...
      <div className="w-full bg-white p-4 shadow-xl sm:mt-0">
        <div className="text-md m-4 flex items-center gap-2 md:text-xl">
          <div>
            ...
            <div className="py-2" />
            <ul className="list-disc ms-4 text-slate-800">
              <li className="flex items-center">
                ...
                >
                  <div className="flex items-center rounded-xl bg-gray-100 p-2 transition duration-200 ease-in-out hover:bg-white hover:shadow-md">
